#!/bin/bash
# DATA_LAKE_RG='DATA_WORKSHOP_MARTIN'
# DATA_LAKE_LOCATION='west europe'
...
DATA_LAKE_STORAGE='martinstorage2'
...
ARM_LOCATION='datafactory.json'
ARM_PROPS_LOCATION='datafactory_prop.json'
...
az group deployment create \
 ...
 DATA_LAKE_SERVER_NAME='sqlservermartin'
DATA_LAKE_DATABASE_NAME='sqldbmartin'
...
az sql server firewall-rule create \
 ...
 DATA_LAKE_WORKFLOW_DB='workflowmartin'
...
az group deployment create \
 ...
 DATA_LAKE_DWH_NAME='sqldwhmartin'
